...
public class AddDocumentitemEntityAction extends ActionSupport{
...
private DocumentitemEntityService documentitemEntityService;
    ...
    public  String execute() throws Exception{
        ...
        DocumentitemEntity bean = new DocumentitemEntity();
	...
	this.documentitemEntityService.saveDocumentitemEntity(bean);
