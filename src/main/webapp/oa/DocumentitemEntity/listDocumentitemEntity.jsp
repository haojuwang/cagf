                ...
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                    ...
                    <s:iterator value="list" var="bean" status="vs">
                        <tr>
                            ...
                            <td align="center">
                                <a href="${pageContext.request.contextPath}/oa/DocumentitemEntity/updatepDocumentitemEntity?id=${bean.id}">编辑</a> |
                                <a href="${pageContext.request.contextPath}/oa/DocumentitemEntity/deleteDocumentitemEntity?id=${bean.id}">删除</a>
                            </td>
