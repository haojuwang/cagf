...
<div id="dcMain">
    ...
    <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="${pageContext.request.contextPath}/oa/DocumentitemEntity/addDocumentitemEntity.jsp" class="actionBtn">添加DocumentitemEntity</a>DocumentitemEntity</h3>
        <div class="filter">
            ...
            <form name="action" method="post" action="product.php?rec=action">
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                    <tr>
                        ...
                        <th width="80" align="center">realSize</th>

                        <th width="80" align="center">size</th>

                        <th width="80" align="center">randomName</th>

                        <th width="80" align="center">type</th>

                        <th width="80" align="center">documentCatalog</th>
                    ...
                    <s:iterator value="list" var="bean" status="vs">
                        <tr>
                            ...
                            <td align="center"><s:property value="realSize" /></td>

                            <td align="center"><s:property value="size" /></td>

                            <td align="center"><s:property value="randomName" /></td>

                            <td align="center"><s:property value="type" /></td>

                            <td align="center"><s:property value="documentCatalog" /></td>


                            <td align="center">
                                <a href="${pageContext.request.contextPath}/oa/DocumentitemEntity/updatepDocumentitemEntity?id=${bean.id}&start=<s:property value='start'/>&range=<s:property value='range'/>">编辑</a> |
                                <a href="${pageContext.request.contextPath}/oa/DocumentitemEntity/deleteDocumentitemEntity?id=${bean.id}&start=<s:property value='start'/>&range=<s:property value='range'/>">删除</a>
                            </td>
